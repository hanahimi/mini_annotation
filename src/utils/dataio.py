...
def update_file_by_keyheader(src_file, key_header, newline=""):
    """
    1 open a txt-like file
    2 search a line with key_header
    3 replace this line with newline
    """
    lines = []
